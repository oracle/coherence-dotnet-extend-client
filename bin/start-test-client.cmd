...
:launch
@echo on
"%JAVA_EXEC%" -server -showversion %JAVA_OPTS% %SYS_OPTS% -cp "%DEV_ROOT%\tests\Coherence.Tests\config;%DEV_ROOT%\build\classes;%DEV_ROOT%\lib\java\coherence.jar" com.tangosol.net.CacheFactory
@echo off
goto end
