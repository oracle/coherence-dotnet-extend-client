...
namespace Tangosol.Util
{
    ...
    public class NullImplementationTests
    {
        ...
        {
            Assert.That(() => NullImplementation.NullCollection.Instance.SyncRoot, Throws.InvalidOperationException);
        }
        ...
        public void TestNullCollectionEnumeratorCurrent()
        {
            ...
            Assert.That(() => enumerator.Current, Throws.InvalidOperationException);
        }
        ...
        public void TestNullDictionaryEnumeratorKey()
        {
            ...
            Assert.That(() => nullEnumerator.Key, Throws.InvalidOperationException);
        }
        ...
        {
            IDictionaryEnumerator nullEnumerator = NullImplementation.NullDictionary.Instance.GetEnumerator();
            Assert.That(() => nullEnumerator.Value, Throws.InvalidOperationException);
        }
        ...
        {
            IDictionaryEnumerator nullEnumerator = NullImplementation.NullDictionary.Instance.GetEnumerator();
            Assert.That(() => nullEnumerator.Entry, Throws.InvalidOperationException);
        }
