...
namespace Tangosol.IO.Pof
{
    ...
    public class PofStreamCollectionTests
    {
        ...
        public void TestPofStreamWriteArrayException()
        {
            initPOFWriter();
            stream.Close();
            Assert.That(() => pofwriter.WriteArray(0, new object[] { "test", "test1", "test2" }),
        ...
        public void TestPofStreamWriteUniformArrayException()
        {
            initPOFWriter();
            stream.Close();
            Assert.That(() => pofwriter.WriteArray(0, new object[] { "test", "test1", "test2" }, typeof(String)), Throws.TypeOf<ObjectDisposedException>());
        }
        ...
        public void TestPofStreamWriteWriteCollection()
        {
            ...
            Assert.That(() => pofreader.ReadCollection(0, null), Throws.TypeOf<IOException>());
        }
        ...
        public void TestPofStreamWriteCollectionException()
        {
            initPOFWriter();
            stream.Close();
            Assert.That(() => pofwriter.WriteCollection(0, new ArrayList(0)), Throws.TypeOf<ObjectDisposedException>());
        }
        ...
        public void TestPofStreamWriteUniformCollectionException()
        {
            initPOFWriter();
            stream.Close();
            Assert.That(() => pofwriter.WriteCollection(0, new ArrayList(0), typeof(String)), Throws.TypeOf<ObjectDisposedException>());
        }
        ...
        public void TestPofStreamWriteDictionaryException()
        {
            initPOFWriter();
            stream.Close();
            Assert.That(() => pofwriter.WriteDictionary(0, new Hashtable(0)), Throws.TypeOf<ObjectDisposedException>());
        }
        ...
        public void TestPofStreamWriteWriteUniformDictionary()
        {
            ...
            Assert.That(() => pofreader.ReadDictionary(0, null), Throws.TypeOf<IOException>());
        }
        ...
        public void TestPofStreamWriteDictionaryEx3Exception()
        {
            initPOFWriter();
            stream.Close();
            Assert.That(() => pofwriter.WriteDictionary(0, new Hashtable(0), typeof(int)), Throws.TypeOf<ObjectDisposedException>());
        }
        ...
        public void TestPofStreamWriteDictionaryEx4Exception()
        {
            initPOFWriter();
            stream.Close();
            Assert.That(() => pofwriter.WriteDictionary(0, new Hashtable(0), typeof(int), typeof(int)), Throws.TypeOf<ObjectDisposedException>());
        }
