...
namespace Tangosol.IO.Pof
{
    ...
    public class PofStreamPrimitiveArrayTests
    {
        ...
        public void TestWriteBooleanArrayWithException()
        {
            ...
            initPOFWriter();
            stream.Close();
            pofWriter.WriteBooleanArray(0, array);
        }
        ...
        public void TestWriteByteArrayWithException()
        {
            ...
            initPOFWriter();
            stream.Close();
            pofWriter.WriteByteArray(0, array);
        }
        ...
        public void TestWriteCharArrayWithException()
        {
            ...
            initPOFWriter();
            stream.Close();
            pofWriter.WriteCharArray(0, array);
        }
        ...
        public void TestWriteInt16ArrayWithException()
        {
            ...
            initPOFWriter();
            stream.Close();
            pofWriter.WriteInt16Array(0, array);
        }
        ...
        public void TestWriteInt32ArrayWithException()
        {
            ...
            initPOFWriter();
            stream.Close();
            pofWriter.WriteInt32Array(0, array);
        }
        ...
        public void TestWriteInt64ArrayWithException()
        {
            ...
            initPOFWriter();
            stream.Close();
            pofWriter.WriteInt64Array(0, array);
        }
        ...
        public void TestWriteSingleArrayWithException()
        {
            ...
            initPOFWriter();
            stream.Close();
            pofWriter.WriteSingleArray(0, array);
        }
        ...
        public void TestWriteDoubleArrayWithException()
        {
            ...
            initPOFWriter();
            stream.Close();
            pofWriter.WriteDoubleArray(0, array);
        }
