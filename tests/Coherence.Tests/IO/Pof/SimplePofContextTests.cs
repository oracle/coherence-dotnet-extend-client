...
namespace Tangosol.IO.Pof
{
    ...
    public class SimplePofContextTests
    {
        ...
        public void TestTypeRegistrationWithNullType()
        {
            ...
            Assert.That(() => ctx.RegisterUserType(1, null, null), Throws.ArgumentNullException);
        }
        ...
        {
            SimplePofContext ctx = new SimplePofContext();
            Assert.That(() => ctx.RegisterUserType(1, this.GetType(), null), Throws.ArgumentNullException);
        }
        ...
        {
            SimplePofContext ctx = new SimplePofContext();
            Assert.That(() => ctx.GetPofSerializer(5), Throws.ArgumentException);
        }
        ...
        {
            SimplePofContext ctx = new SimplePofContext();
            Assert.That(() => ctx.GetType(5), Throws.ArgumentException);
        }
        ...
        {
            SimplePofContext ctx = new SimplePofContext();
            Assert.That(() => ctx.GetUserTypeIdentifier(this.GetType()), Throws.ArgumentException);
        }
        ...
        {
            SimplePofContext ctx = new SimplePofContext();
            Assert.That(() => ctx.GetUserTypeIdentifier((String)null), Throws.ArgumentNullException);
        }
        ...
        {
            SimplePofContext ctx = new SimplePofContext();
            Assert.That(() => ctx.GetUserTypeIdentifier(this.GetType().AssemblyQualifiedName), Throws.ArgumentException);
        }
        ...
        public void TestDeserializationException()
        {
            ...
            stream.Position = 0;
            stream.Close();
            Assert.That(() => ctx.Deserialize(new DataReader(stream)), Throws.ArgumentException);
        }
        ...
        public void TestSerializationWithNonPortableType()
        {
            ...
            PersonLite ana = new PersonLite("Ana Maria Seovic", new DateTime(2004, 8, 14));

            Stream stream = new MemoryStream();
            Assert.That(() => ctx.Serialize(new DataWriter(stream), ana), Throws.TypeOf<IOException>());
        }
        ...
        public void TestSerializationWithBackwardsReadingType()
        {
            ...
            BadPersonLite ana = new BadPersonLite("Ana Maria Seovic", new DateTime(2004, 8, 14));

            Stream stream = new MemoryStream();
            ctx.Serialize(new DataWriter(stream), ana);

            stream.Position = 0;
            Assert.That(() => ctx.Deserialize(new DataReader(stream)), Throws.InvalidOperationException);
        }
        ...
        public void TestSerializationWithSkippingReadingType()
        {
            ...
            stream.Position = 0;
            Assert.That(() => ctx.Deserialize(new DataReader(stream)), Throws.TypeOf<EndOfStreamException>());
        }
