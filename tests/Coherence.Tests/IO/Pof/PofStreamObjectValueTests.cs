...
namespace Tangosol.IO.Pof
{
    ...
    public class PofStreamObjectValueTests
    {
        ...
        public void TestUniversalTimeWithException()
        {
            ...
            initPOFWriter();
            stream.Close();
            pofWriter.WriteUniversalTime(0, t);
        }
        ...
        public void TestWriteYearMonthIntervalWithException()
        {
            initPOFWriter();
            stream.Close();
            pofWriter.WriteRawYearMonthInterval(0, new RawYearMonthInterval(30, 1));
        }
        ...
        public void TestReadYearMonthIntervalWithException()
        {
            ...
            initPOFReader();
            pofReader.ReadRawYearMonthInterval(0);
        }
        ...
        public void TestWriteTimeIntervalWithException()
        {
            initPOFWriter();
            stream.Close();
            pofWriter.WriteTimeInterval(0, new TimeSpan(5, 14, 10, 30, 10));
        }
        ...
        public void TestReadDayTimeIntervalWithException()
        {
            ...
            initPOFReader();
            pofReader.ReadDayTimeInterval(0);
        }
        ...
        public void TestWriteDayTimeIntervalWithException()
        {
            initPOFWriter();
            stream.Close();
            pofWriter.WriteDayTimeInterval(0, new TimeSpan(3, 5, 6, 7, 8));
        }
        ...
        public void TestDecimalOverflow()
        {
            ...
            initPOFReader();
            decimal d = pofReader.ReadDecimal(0);
        }
