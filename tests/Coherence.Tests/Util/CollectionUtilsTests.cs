...
namespace Tangosol.Util
{
    ...
    public class CollectionUtilsTests
    {
        ...
        {
            CollectionUtils.AddAll(new object[] {1, "2", '3'}, new object[] {4, "5", '6'});
        }
        ...
        {
            CollectionUtils.AddAll(new BitArray(10), new bool[] {true, false, false});
        }
        ...
        public void TestDictionaryException()
        {
            ...
            CollectionUtils.AddAll( target, new Object[] {"one", 1, "two", 2, "three", 3});
        }
