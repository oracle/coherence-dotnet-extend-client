...
namespace Tangosol.Util.Aggregator
{
    ...
    public abstract class AbstractDoubleAggregator : AbstractAggregator
    {
        #region Constructors
        ...
        /// </param>
        public AbstractDoubleAggregator(IValueExtractor extractor) : base(extractor)
        {}
        ...
        /// </param>
        public AbstractDoubleAggregator(string member) : base(member)
        {}
