...
namespace Tangosol.Util.Aggregator
{
    ...
    public class DecimalMin : AbstractDecimalAggregator
    {
        #region Constructors
        ...
        /// </param>
        public DecimalMin(IValueExtractor extractor) : base(extractor)
        {}
        ...
        /// </param>
        public DecimalMin(string member) : base(member)
        {}
