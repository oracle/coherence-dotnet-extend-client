...
namespace Tangosol.Util.Aggregator
{
    ...
    public class DecimalSum : AbstractDecimalAggregator
    {
        #region Constructors
        ...
        /// </param>
        public DecimalSum(IValueExtractor extractor) : base(extractor)
        {}
        ...
        /// </param>
        public DecimalSum(string member) : base(member)
        {}
