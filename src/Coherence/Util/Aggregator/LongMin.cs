...
namespace Tangosol.Util.Aggregator
{
    ...
    public class LongMin : AbstractLongAggregator
    {
        #region Constructors
        ...
        /// </param>
        public LongMin(IValueExtractor extractor)
            : base(extractor)
        {}
        ...
        protected override void Process(object o, bool isFinal)
        {
            if (o != null)
            {
                m_result = Math.Min(m_result, Convert.ToInt64(o));
                m_count++;
            }
        }
