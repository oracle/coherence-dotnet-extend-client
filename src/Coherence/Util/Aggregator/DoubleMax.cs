...
namespace Tangosol.Util.Aggregator
{
    ...
    public class DoubleMax : AbstractDoubleAggregator
    {
        #region Constructors
        ...
        /// </param>
        public DoubleMax(IValueExtractor extractor) : base(extractor)
        {}
        ...
        /// </param>
        public DoubleMax(string member) : base(member)
        {}
        ...
        protected override void Process(object o, bool isFinal)
        {
            if (o != null)
            {
                m_result = Math.Max(m_result, Convert.ToDouble(o));
                m_count++;
            }
        }
