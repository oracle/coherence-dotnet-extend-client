...
namespace Tangosol.Util.Filter
{
    ...
    public class NeverFilter : IIndexAwareFilter, IPortableObject
    {
        ...
        /// </summary>
        public static readonly NeverFilter Instance = new NeverFilter();
