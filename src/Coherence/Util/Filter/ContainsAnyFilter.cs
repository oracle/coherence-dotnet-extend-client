...
namespace Tangosol.Util.Filter
{
    ...
    public class ContainsAnyFilter : ComparisonFilter, IIndexAwareFilter
    {
        #region Constructors
        ...
        /// </param>
        public ContainsAnyFilter(IValueExtractor extractor, ICollection values)
        ...
        /// array is tested to contain.
        /// </param>
        public ContainsAnyFilter(string member, ICollection values)
        ...
        protected internal override bool EvaluateExtracted(object extracted)
        {
            ...
            {
                var colExtracted = (ICollection) extracted;
                foreach (object o in (ICollection) Value)
                {
                    if (CollectionUtils.Contains(colExtracted, o))
                    {
                        return true;
                    }
                }
