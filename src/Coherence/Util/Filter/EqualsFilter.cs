...
namespace Tangosol.Util.Filter
{
    ...
    public class EqualsFilter : ComparisonFilter, IIndexAwareFilter
    {
        #region Constructors
        ...
        /// </param>
        public EqualsFilter(IValueExtractor extractor, object value)
        ...
        /// The object to compare the result with.
        /// </param>
        public EqualsFilter(string member, object value)
            : base(member, value)
        {}
        ...
        /// </param>
        public EqualsFilter(string member, int value)
        ...
        /// </param>
        public EqualsFilter(string member, long value)
            : this(member, (object) value)
        {}
        ...
        /// </param>
        public EqualsFilter(string member, float value)
            : this(member, (object) value)
        {}
        ...
        /// </param>
        public EqualsFilter(string member, double value)
            : this(member, (object) value)
        {}
