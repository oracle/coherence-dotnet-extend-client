...
namespace Tangosol.Net.Cache
{
    ...
    public class WrapperNamedCache : INamedCache
    {
        #region Properties
        ...
        /// <summary>
        /// Gets the <see cref="ICacheService"/> that this INamedCache
        /// is a part of.
        /// </summary>
        /// <value>
        ...
        public virtual ICacheService CacheService
        {
            get
            {
                return NamedCache.CacheService;
            }
        }
        ...
        public virtual bool IsActive
        {
            get
            {
                return NamedCache == null ? false : NamedCache.IsActive;
            }
        }
        ...
        {
            get { return m_namedCache.IsSynchronized; }
        }
        ...
        {
            get { return NamedCache.IsReadOnly; }
        }
        ...
        {
            get { return NamedCache.IsFixedSize; }
        }
        ...
        {
            return ((IEnumerable) NamedCache).GetEnumerator();
        }
        ...
        {
            return ((IDictionary) NamedCache).GetEnumerator();
        }
        ...
        {
            return NamedCache.GetValues(filter);
        }
        ...
        {
            return NamedCache.GetEntries(filter);
        }
