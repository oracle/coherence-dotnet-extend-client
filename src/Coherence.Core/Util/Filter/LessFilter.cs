...
namespace Tangosol.Util.Filter
{
    ...
    public class LessFilter : ComparisonFilter, IIndexAwareFilter
    {
        #region Constructors
        ...
        /// </param>
        public LessFilter(IValueExtractor extractor, IComparable value)
        ...
        /// The object to compare the result with.
        /// </param>
        public LessFilter(string member, IComparable value)
            : base(member, value)
        {}
        ...
        /// </param>
        public LessFilter(string member, int value)
        ...
        /// </param>
        public LessFilter(string member, long value)
            : this(member, (IComparable) value)
        {}
        ...
        /// </param>
        public LessFilter(string member, float value)
            : this(member, (IComparable) value)
        {}
        ...
        /// </param>
        public LessFilter(string member, double value)
            : this(member, (IComparable) value)
        {}
        ...
        public IFilter ApplyIndex(IDictionary indexes, ICollection keys)
        {
            ...
            if (index.IsOrdered)
            {
                ...
                {
                    var setLT = new HashSet();
                    foreach (ICollection col in sortedLT.Values)
                    {
                        if (col != colNULL)
                        {
                            CollectionUtils.AddAll(setLT, col);
                        }
                    }
                    CollectionUtils.RetainAll(keys, setLT);
                }
            }
            else
            {
                ...
                if (index.IsPartial)
                {
                    ...
                    foreach (DictionaryEntry entry in contents)
                    {
                        ...
                        {
                            CollectionUtils.AddAll(setLT, (ICollection) entry.Value);
                        }
                    }
                    CollectionUtils.RetainAll(keys, setLT);
                }
