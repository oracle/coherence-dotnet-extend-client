...
namespace Tangosol.Util.Filter
{
    ...
    public class NotEqualsFilter : ComparisonFilter, IIndexAwareFilter
    {
        #region Constructors
        ...
        /// </param>
        public NotEqualsFilter(IValueExtractor extractor, object value)
        ...
        /// The object to compare the result with.
        /// </param>
        public NotEqualsFilter(string member, object value)
            : base(member, value)
        {}
        ...
        /// </param>
        public NotEqualsFilter(string member, int value)
        ...
        /// </param>
        public NotEqualsFilter(string member, long value)
            : this(member, (object) value)
        {}
        ...
        /// </param>
        public NotEqualsFilter(string member, float value)
            : this(member, (object) value)
        {}
        ...
        /// </param>
        public NotEqualsFilter(string member, double value)
            : this(member, (object) value)
        {}
        ...
        public IFilter ApplyIndex(IDictionary indexes, ICollection keys)
        {
            ...
            if (index.IsPartial)
            {
                var setNE = new HashSet();
                foreach (DictionaryEntry entry in contents)
                {
                    if (!entry.Key.Equals(value))
                    {
                        var col = (ICollection) entry.Value;
                        CollectionUtils.AddAll(setNE, col);
                    }
                }
                CollectionUtils.RetainAll(keys, setNE);
            }
            else
            {
