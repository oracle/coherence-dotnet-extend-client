...
namespace Tangosol.Util.Aggregator
{
    ...
    public class LongMax : AbstractLongAggregator
    {
        #region Constructors
        ...
        /// </param>
        public LongMax(IValueExtractor extractor)
            : base(extractor)
        {}
        ...
        protected override void Process(object o, bool isFinal)
        {
            if (o != null)
            {
                m_result = Math.Max(m_result, Convert.ToInt64(o));
                m_count++;
            }
        }
