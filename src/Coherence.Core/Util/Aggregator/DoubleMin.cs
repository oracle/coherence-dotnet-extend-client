...
namespace Tangosol.Util.Aggregator
{
    ...
    public class DoubleMin : AbstractDoubleAggregator
    {
        #region Constructors
        ...
        /// </param>
        public DoubleMin(IValueExtractor extractor)
            : base(extractor)
        { }
        ...
        /// </param>
        public DoubleMin(string member)
            : base(member)
        { }
        ...
        protected override void Process(object o, bool isFinal)
        {
            if (o != null)
            {
                m_result = Math.Min(m_result, Convert.ToDouble(o));
                m_count++;
            }
        }
